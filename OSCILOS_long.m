...
msg = {     '<HTML><FONT color="red">Welcome to OSCILOS_long!';...
            'version 1.4.8';...
            '';...
            '<HTML><FONT color="blue">Please note that the recommended versions of Matlab are 2013b,2014a,2014b,2015a!';...
            '<HTML><FONT color="black">Last revision date: April 10, 2017'};%;...
%             '';...
