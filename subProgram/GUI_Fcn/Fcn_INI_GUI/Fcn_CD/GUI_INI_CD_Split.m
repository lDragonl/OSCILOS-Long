...
msg={   '<HTML><FONT color="blue">Some sections are set to gradually area change sections;';...
        ...
        '<HTML><FONT color="blue">Please set the splitted number for every section;';...
...
for k = 1:2
    StringSplit{k} = ['Splitted section number:' num2str(k)]; 
end
set(handles.pop1,...
                        'units', 'points',...
                        'Fontunits','points',...
...
global CI
N = length(CI.CD.indexGC); % number of sections to be splitted
