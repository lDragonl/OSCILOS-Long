...
% Last Modified by GUIDE v2.5 15-Dec-2014 23:28:12
...
set(handles.uipanel_axes,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.5/20 FigH*10.0/20 FigW*19/20 FigH*9.75/20],...
                        'Title','Plots:',...
                        'visible','on',...
...
set(handles.uipanel_ITP,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.5/20 FigH*8.0/20 FigW*19/20 FigH*2.0/20],...
...
set(handles.edit_TP_p1,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*1.75/10 pH*2/10 pW*1.25/10 pH*4.5/10],...
                        'fontsize',handles.FontSize(2),...
                        'string',101325,...
                        'backgroundcolor',handles.bgcolor{1},...
...
set(handles.edit_TP_T1,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*5/10 pH*2/10 pW*1.25/10 pH*4.5/10],...
                        'fontsize',handles.FontSize(2),...
                        'string',293.15,...
                        'backgroundcolor',handles.bgcolor{1},...
                        'horizontalalignment','right');
