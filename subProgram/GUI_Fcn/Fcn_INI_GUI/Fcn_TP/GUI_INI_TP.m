...
% Last Modified by GUIDE v2.5 04-Dec-2014 09:35:49
...
set(handles.uipanel_axes,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.5/20 FigH*10.25/20 FigW*19/20 FigH*9.5/20],...
                        'Title','Plots:',...
                        'visible','on',...
...
set(handles.axes1,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*1/10 pH*2/10 pW*6/10 pH*7/10],...
...
set(handles.uipanel_ITP,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.5/20 FigH*8.25/20 FigW*19/20 FigH*1.75/20],...
...
set(handles.uipanel_Heat_Config,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.5/20 FigH*1.75/20 FigW*19/20 FigH*3/20],...
                        'Title','',...
                        'visible','on',...
                        'highlightcolor',handles.bgcolor{3},...
                        'borderwidth',1,...
