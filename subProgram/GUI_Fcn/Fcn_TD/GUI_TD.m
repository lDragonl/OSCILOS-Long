function varargout = GUI_TD(varargin)
% GUI_TD MATLAB code for GUI_TD.fig
%      GUI_TD, by itself, creates a new GUI_TD or raises the existing
%      singleton*.
%
%      H = GUI_TD returns the handle to a new GUI_TD or the handle to
%      the existing singleton*.
%
%      GUI_TD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_TD.M with the given input arguments.
%
%      GUI_TD('Property','Value',...) creates a new GUI_TD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_TD_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_TD_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_TD

% Last Modified by GUIDE v2.5 20-Nov-2014 15:50:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_TD_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_TD_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
%
...
% --- Executes just before GUI_TD is made visible.
function GUI_TD_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_TD (see VARARGIN)

% Choose default command line output for GUI_TD
...
function varargout = GUI_TD_OutputFcn(hObject, eventdata, handles) 
try
...
string={...
            ...
            'Version: 1.2';...
            '';...
            'Developed by Dr. Jingxuan LI and Dr. Aimee S.MORGANS';...
