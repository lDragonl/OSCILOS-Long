...
% Last Modified by GUIDE v2.5 21-Nov-2014 11:18:18
...
set(handles.uipanel_Time,...
                        'units', 'points',...
                        'fontUnits','points',...
                        'position',[FigW*0.5/20 FigH*14.5/20 FigW*19/20 FigH*5.25/20],...
...
set(handles.uipanel_Speed,...
                        'units', 'points',...
                        'fontUnits','points',...
                        'position',[FigW*0.5/20 FigH*10.25/20 FigW*19/20 FigH*4/20],...
...
set(handles.uipanel_Limit,...
                        'units', 'points',...
                        'fontUnits','points',...
                        'position',[FigW*0.5/20 FigH*7.5/20 FigW*19/20 FigH*2.5/20],...
                        'Title','Velocity ratio up-limit ',...
                        'visible','on',...
                        'highlightcolor',handles.bgcolor{3},...
                        'borderwidth',1,...
                        'fontsize',handles.FontSize(2),...
...
set(handles.uipanel_BN,...
                        'units', 'points',...
                        'fontUnits','points',...
                        'position',[FigW*0.5/20 FigH*1.75/20 FigW*19/20 FigH*5.5/20],...
