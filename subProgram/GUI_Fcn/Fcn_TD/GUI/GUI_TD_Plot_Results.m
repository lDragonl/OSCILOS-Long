...
% Last Modified by GUIDE v2.5 16-Dec-2014 08:45:43
...
set(handles.uipanel_listbox,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.25/20 FigH*12/20 FigW*9.5/20 FigH*7.75/20],...
                        'Title','',...
                        'visible','on',...
                        'highlightcolor',handles.bgcolor{3},...
                        'borderwidth',1,...
...
set(handles.uipanel_Select,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[FigW*0.25/20 FigH*2.5/20 FigW*9.5/20 FigH*9.25/20],...
                        'Title','',...
                        'visible','on',...
                        'highlightcolor',handles.bgcolor{3},...
                        'borderwidth',1,...
...
set(handles.text1,      'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*0.5/10 pH*6/10 pW*3/10 pH*1.5/10],...
                        'fontsize',handles.FontSize(1),...
                        'string','Data type:',...
                        'backgroundcolor',handles.bgcolor{3},...
...
set(handles.pop1,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*3.5/10 pH*6/10 pW*6/10 pH*1.75/10],...
                        'fontsize',handles.FontSize(2),...
                        'string',{  'uRatio before the heat perturbation interface 1'},...
...
set(handles.text2,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*0.5/10 pH*2/10 pW*3/10 pH*1.5/10],...
                        'fontsize',handles.FontSize(1),...
                        'string','Plot type:',...
                        'backgroundcolor',handles.bgcolor{3},...
                        'horizontalalignment','left',...
...
set(handles.pop2,...
                        'units', 'points',...
                        'Fontunits','points',...
                        'position',[pW*3.5/10 pH*2/10 pW*6/10 pH*1.75/10],...
                        'fontsize',handles.FontSize(2),...
...
switch popPlot
    case 1  % time evolution
        plot(hAxes1,1*CI.TD.tSpTotal,CI.TD.uRatio(CI.TD.indexFMJLI,:),'-k','linewidth',0.5);
    ...
    case 2  % psd
        PSD_plot = calculate_psd(yData,Fs);
