...
CI.TD.qRatio            = zeros(1,CI.TD.nTotal);                            % heat release ratio
CI.TD.uRatio            = zeros(1,CI.TD.nTotal);                            % velocity ratio before the flame
CI.TD.uRatioEnv         = zeros(1,CI.TD.nTotal);                            % envelope of velocity ratio, 
